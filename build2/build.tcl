...
add_files soda_src/soda_top.cpp -cflags "-std=c++14 -DALLOW_EMPTY_HLS_STREAM_READS"
add_files -tb soda_src/soda_csim_tb.cpp -cflags "-std=c++14 -DALLOW_EMPTY_HLS_STREAM_READS"
